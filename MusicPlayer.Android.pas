...
begin
  Result :=(MainActivity.getSystemService(TJContext.JavaClass.AUDIO_SERVICE) as JAudioManager).getStreamVolume(TJAudioManager.JavaClass.STREAM_MUSIC);
  Result := Result / (MainActivity.getSystemService(TJContext.JavaClass.AUDIO_SERVICE) as JAudioManager).getStreamMaxVolume(TJAudioManager.JavaClass.STREAM_MUSIC);
end;
